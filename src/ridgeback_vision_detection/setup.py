...
package_name = 'ridgeback_vision_detection'
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'detector = ridgeback_vision_detection.detector:main',
            'test_pub = ridgeback_vision_detection.test_pub:main',
            'odom_tf_pub = ridgeback_vision_detection.odom_tf_pub:main',
        ],
    },
)
